...
<?php
$LocaliteDuFournisseur = $_POST["localite_du_f"]
?>
...
<?php
            ...
            try{
                $requete = $BD->prepare("SELECT * FROM Fournisseur WHERE `Localite`=:localiteDuFournisseur");
                $requete->bindValue(':localiteDuFournisseur',$LocaliteDuFournisseur);
                $requete->execute();
